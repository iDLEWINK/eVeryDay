...
public class BitmapToVideoEncoder {
    ...
    private BitmapToVideoEncoderCallback mCallback;
    ...
    public interface BitmapToVideoEncoderCallback {
        void onEncodingComplete(File outputFile);
    }

    public BitmapToVideoEncoder(BitmapToVideoEncoderCallback callback) {
        mCallback = callback;
    }
